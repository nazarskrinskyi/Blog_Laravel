    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-11 mx-auto">
                <h1 class="edica-page-title aos-init aos-animate" data-aos="fade-up">About Us</h1>
                <section class="edica-about-intro py-5">
                    <div class="row">
                        <div class="col-md-6 aos-init" data-aos="fade-right" data-aos-delay="150">
                            <h2 class="intro-title pb-3 pb-md-0 mb-4 mb-md-0">Quick &amp; Easy Process <span>with best features</span></h2>
                        </div>
                        <div class="col-md-6 intro-content aos-init" data-aos="fade-left" data-aos-delay="150">
                ...
                <section class="edica-about-vision py-5">
                    <div class="row">
                        <div class="col-md-6 pb-3 pb-md-0 mb-4 mb-md-0 aos-init" data-aos="fade-right" data-aos-delay="200">
                            <img src="assets/images/about-vision.png" alt="vision" class="img-fluid">
                        </div>
                        <div class="col-md-6 d-flex flex-column justify-content-center">
                            <h2 class="vision-title aos-init" data-aos="fade-left">Our Vision</h2>
                            <p class="vision-text aos-init" data-aos="fade-left">Lorem ipsum, or lipsum as it is sometimes known, is dummy text used in laying out printed graphic or web designs. The passage is at attributed to an unknown typesetters in 1the 5th century who is thought scrambled with all parts of Cicero’s De. Lorem ipsum, or lipsum as it is sometimes known, is dummy text used in laying out printed graphic or web designs</p>
                        </div>
                    </div>
                </section>
                <section class="edica-about-counter py-5 d-md-flex justify-content-between aos-init" id="counter" data-aos="fade-up">
                ...
                <section class="edica-about-goal py-5 mb-5">
                    <div class="row">
                        <div class="col-md-6 mb-4 mb-md-0 d-flex flex-column justify-content-center aos-init" data-aos="fade-right">
                ...
                <section class="edica-about-clients pb-5 mb-5">
                    <h2 class="clients-title mb-5 aos-init" data-aos="fade-up">Top clients</h2>
                    <div class="row py-4 aos-init" data-aos="fade-up">
                ...
                <section class="edica-about-faq py-5 mb-5">
                    <h2 class="faq-title aos-init" data-aos="fade-up">Frequently Asked Queries</h2>
                    <p class="faq-section-text aos-init" data-aos="fade-up" data-aos-delay="100">Lorem ipsum, or lipsum as it is sometimes known, is dummy text used in laying out printed graphic or web designs. </p>
                    <div class="accordion" id="edicaAboutFaqCollapse" role="tablist" aria-multiselectable="true">
                        <div class="card aos-init" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <div class="card aos-init" data-aos="fade-up" data-aos-delay="300">
